...
(function (factory) {
    ...
    defaults = {
        ...
        /**
         ...
         scrolled when controle-de-acesso scrolls the `.content` element.
    ...
    NanoScroll = (function () {
        ...
        /**
         ...
         when controle-de-acesso scrolls the `.nano-content` element.
        ...
        /**
         ...
         Useful if you want to show the controle-de-acesso (e.g. on pageload) that there is more content waiting for him.
         @method flash
         @chainable
         @example
